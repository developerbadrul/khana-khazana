        ...
        <section>
            <div className="grid grid-cols-12 container gap-8 justify-items-center">
                <div className="col-span-12 md:col-span-6">
                    <div className="w-full h-full rounded-lg object-contain">
                        <Image src="https://source.unsplash.com/Zh0mYmMBZjQ/600x600" alt="" width={600} height={600} />
                    </div>
                </div>
                <div className="col-span-12 md:col-span-6 py-8 flex flex-col justify-center">
                    <h2 className="font-semibold text-4xl lg:w-8/12 leading-10">White calzones with marinara sauce</h2>
                    <p className="text-xs text-[#eb4a36] italic my-2">Breakfast and Brunch</p>
                    <p className="text-gray-600 text-sm my-6 leading-6">Supermarket brands of ricotta contain stabilizers, which can
                        give the
                        cheese
                        a gummy
                        texture when baked.
